...
//      );
//    }
//   void update_On(BuildContext context, Setup note, int position) async {
//      await notesReference.child(note.id).update({
//        'completed': true, //on 1
//      });
//    }

//    void update_off(BuildContext context, Setup note, int position) async {
//      await notesReference.child(note.id).update({
//        'completed': false, //off
//      });
//    }  
...
//      await Navigator.push(
//        context,
//        MaterialPageRoute(builder: (context) => NoteScreen(Setup(
//          null,
//                  '',
//                  '',
//                  '',
