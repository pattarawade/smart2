...
class SwitchWidgetClass extends State {
  ...
  void readTimeOn() async {
    databaseReference
        .reference()
        .child('notes/setting')
        .once()
        .then((DataSnapshot snaptime) {
      Map<dynamic, dynamic> t = snaptime.value;
      t.forEach((key, s) {
        DateTime to = s['lightOn'];
        print(to);
        if (now == to) {
          updatelight();
        }
